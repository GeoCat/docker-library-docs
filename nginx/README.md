...
-	[`1.31.0`, `mainline`, `1`, `1.31`, `latest`, `1.31.0-trixie`, `mainline-trixie`, `1-trixie`, `1.31-trixie`, `trixie`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/mainline/debian/Dockerfile)

-	[`1.31.0-perl`, `mainline-perl`, `1-perl`, `1.31-perl`, `perl`, `1.31.0-trixie-perl`, `mainline-trixie-perl`, `1-trixie-perl`, `1.31-trixie-perl`, `trixie-perl`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/mainline/debian-perl/Dockerfile)

-	[`1.31.0-otel`, `mainline-otel`, `1-otel`, `1.31-otel`, `otel`, `1.31.0-trixie-otel`, `mainline-trixie-otel`, `1-trixie-otel`, `1.31-trixie-otel`, `trixie-otel`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/mainline/debian-otel/Dockerfile)

-	[`1.31.0-alpine`, `mainline-alpine`, `1-alpine`, `1.31-alpine`, `alpine`, `1.31.0-alpine3.23`, `mainline-alpine3.23`, `1-alpine3.23`, `1.31-alpine3.23`, `alpine3.23`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/mainline/alpine/Dockerfile)

-	[`1.31.0-alpine-perl`, `mainline-alpine-perl`, `1-alpine-perl`, `1.31-alpine-perl`, `alpine-perl`, `1.31.0-alpine3.23-perl`, `mainline-alpine3.23-perl`, `1-alpine3.23-perl`, `1.31-alpine3.23-perl`, `alpine3.23-perl`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/mainline/alpine-perl/Dockerfile)

-	[`1.31.0-alpine-slim`, `mainline-alpine-slim`, `1-alpine-slim`, `1.31-alpine-slim`, `alpine-slim`, `1.31.0-alpine3.23-slim`, `mainline-alpine3.23-slim`, `1-alpine3.23-slim`, `1.31-alpine3.23-slim`, `alpine3.23-slim`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/mainline/alpine-slim/Dockerfile)

-	[`1.31.0-alpine-otel`, `mainline-alpine-otel`, `1-alpine-otel`, `1.31-alpine-otel`, `alpine-otel`, `1.31.0-alpine3.23-otel`, `mainline-alpine3.23-otel`, `1-alpine3.23-otel`, `1.31-alpine3.23-otel`, `alpine3.23-otel`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/mainline/alpine-otel/Dockerfile)

-	[`1.30.1`, `stable`, `1.30`, `1.30.1-trixie`, `stable-trixie`, `1.30-trixie`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/stable/debian/Dockerfile)

-	[`1.30.1-perl`, `stable-perl`, `1.30-perl`, `1.30.1-trixie-perl`, `stable-trixie-perl`, `1.30-trixie-perl`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/stable/debian-perl/Dockerfile)

-	[`1.30.1-otel`, `stable-otel`, `1.30-otel`, `1.30.1-trixie-otel`, `stable-trixie-otel`, `1.30-trixie-otel`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/stable/debian-otel/Dockerfile)

-	[`1.30.1-alpine`, `stable-alpine`, `1.30-alpine`, `1.30.1-alpine3.23`, `stable-alpine3.23`, `1.30-alpine3.23`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/stable/alpine/Dockerfile)

-	[`1.30.1-alpine-perl`, `stable-alpine-perl`, `1.30-alpine-perl`, `1.30.1-alpine3.23-perl`, `stable-alpine3.23-perl`, `1.30-alpine3.23-perl`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/stable/alpine-perl/Dockerfile)

-	[`1.30.1-alpine-slim`, `stable-alpine-slim`, `1.30-alpine-slim`, `1.30.1-alpine3.23-slim`, `stable-alpine3.23-slim`, `1.30-alpine3.23-slim`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/stable/alpine-slim/Dockerfile)

-	[`1.30.1-alpine-otel`, `stable-alpine-otel`, `1.30-alpine-otel`, `1.30.1-alpine3.23-otel`, `stable-alpine3.23-otel`, `1.30-alpine3.23-otel`](https://github.com/nginx/docker-nginx/blob/d19b67749e7f9087801ae9f7275eec343753eed8/stable/alpine-otel/Dockerfile)
